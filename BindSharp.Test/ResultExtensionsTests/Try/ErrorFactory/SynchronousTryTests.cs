namespace BindSharp.Test.ResultExtensionsTests.Try.ErrorFactory;
...
public sealed class SynchronousTryTests
{
    ...
    public void Try_WithErrorFactory_WhenOperationThrows_ReturnsFailureWithTransformedError()
    {
        ...
        // Act
        var result = ResultExtensions.Try<bool, string>(
            () => throw exception,
    ...
    public void Try_WithErrorFactory_CanReturnComplexErrorObject()
    {
        ...
        // Act
        var result = ResultExtensions.Try<bool, Response>(
    ...
    {
        // Act
        var result1 = ResultExtensions.Try<bool, string>(
        ...
        var result2 = ResultExtensions.Try<bool, string>(
